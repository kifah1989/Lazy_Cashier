...
class ExtendedCurrency {
     ...
     * COMPARATORS
     */
    class ISOCodeComparator :
        Comparator<ExtendedCurrency> {
     ...
     */
        private var allCurrenciesList: List<ExtendedCurrency>? =
            null
        ...
        fun getCurrencyByISO(currencyIsoCode: String): ExtendedCurrency? { // Because the data we have is sorted by ISO codes and not by names, we must check all
// currencies one by one
        ...
        fun getCurrencyByName(currencyName: String): ExtendedCurrency? { // Because the data we have is sorted by ISO codes and not by names, we must check all
// currencies one by one
            for (c in CURRENCIES) {
